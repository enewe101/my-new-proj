# Set environment
source <(curl https://raw.githubusercontent.com/enewe101/my-new-proj/master/.env.dev)
...
wget https://raw.githubusercontent.com/enewe101/my-new-proj/master/config/.vimrc -O /home/$HOST_USER/.vimrc
...
git clone https://github.com/enewe101/my-new-proj.git /home/$HOST_USER/app 
